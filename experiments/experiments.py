...
parser.add_argument('--mode', type=str, default="schoko", help='schoko for using schoko, vanilla for not using ')
...
for level_id in tqdm(range(NUM_LEVELS)):
    ...
    outcome = solver.solve(level_id+1, args.folder, args.num_iters, args.verbose, args.mode)
